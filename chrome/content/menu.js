...
var eG_menuItems = [
  ...
  new eG_menuItem(8,    0, "reload",             "eGf.reload();"),
  new eG_menuItem(9,    0, "up",                 "eGf.up();"),
  new eG_menuItem(10,   0, "root",               "eGf.root();"),
  new eG_menuItem(11,   0, "pageTop",            "eGf.pageTop();"),
  new eG_menuItem(12,   0, "pageBottom",         "eGf.pageBottom();"),
  new eG_menuItem(13,   0, "autoscrolling",      "eGf.autoscrolling();"),
  ...
  new eG_menuItem(24,   0, "quit",               "eGf.quit();"),
  new eG_menuItem(25,   0, "minimizeWindow",     "eGf.minimizeWindow();"),
  new eG_menuItem(26,   0, "fullscreen",         "eGf.fullscreen();"),

  new eG_menuItem(27,   0, "openLink",           "eGf.openLink();"),
  new eG_menuItem(28,   0, "openLinkNewWindow",  "eGf.openLinkNewWindow();"),
  new eG_menuItem(29,   0, "copyLink",           "eGf.copyLink();"),
  new eG_menuItem(30,  -1, "empty",              null),
  new eG_menuItem(31,   0, "copyImageLocation",  "eGf.copyImageLocation();"),
  new eG_menuItem(32,   0, "saveLinkAs",         "eGf.saveLinkAs();"),
  new eG_menuItem(33,   0, "saveImageAs",        "eGf.saveImageAs();"),
  new eG_menuItem(34,   0, "savePageAs",         "eGf.savePageAs();"),
  ...
  new eG_menuItem(39,   0, "searchWeb",          "eGf.searchWeb();"),
  ...
  new eG_menuItem(51,   0, "loadURLScript1",     "eGf.loadURLScript(1);"),
  new eG_menuItem(52,   0, "loadURLScript2",     "eGf.loadURLScript(2);"),
  new eG_menuItem(53,   0, "loadURLScript3",     "eGf.loadURLScript(3);"),
  new eG_menuItem(54,   0, "loadURLScript4",     "eGf.loadURLScript(4);"),
  new eG_menuItem(55,   0, "loadURLScript5",     "eGf.loadURLScript(5);"),
  new eG_menuItem(56,   0, "loadURLScript6",     "eGf.loadURLScript(6);"),
  new eG_menuItem(57,   0, "loadURLScript7",     "eGf.loadURLScript(7);"),
  new eG_menuItem(58,   0, "loadURLScript8",     "eGf.loadURLScript(8);"),
  new eG_menuItem(59,   0, "loadURLScript9",     "eGf.loadURLScript(9);"),
  new eG_menuItem(60,   0, "loadURLScript10",    "eGf.loadURLScript(10);"),
  new eG_menuItem(61,   0, "loadURLScript11",    "eGf.loadURLScript(11);"),
  new eG_menuItem(62,   0, "loadURLScript12",    "eGf.loadURLScript(12);"),
  new eG_menuItem(63,   0, "loadURLScript13",    "eGf.loadURLScript(13);"),
  new eG_menuItem(64,   0, "loadURLScript14",    "eGf.loadURLScript(14);"),
  new eG_menuItem(65,   0, "loadURLScript15",    "eGf.loadURLScript(15);"),
  new eG_menuItem(66,   0, "loadURLScript16",    "eGf.loadURLScript(16);"),
  new eG_menuItem(67,   0, "loadURLScript17",    "eGf.loadURLScript(17);"),
  new eG_menuItem(68,   0, "loadURLScript18",    "eGf.loadURLScript(18);"),
  new eG_menuItem(69,   0, "loadURLScript19",    "eGf.loadURLScript(19);"),
  new eG_menuItem(70,   0, "loadURLScript20",    "eGf.loadURLScript(20);"),

  new eG_menuItem(71,   0, "markVisitedLinks",   "eGf.markVisitedLinks();"),
  new eG_menuItem(72,   0, "bookmarkThisLink",   "eGf.bookmarkThisLink();"),
  new eG_menuItem(73,   0, "bookmarkPage",       "eGf.bookmarkPage();"),
  ...
  new eG_menuItem(78,   0, "viewPageSource",     "eGf.viewPageSource();"),
  new eG_menuItem(79,   0, "viewPageInfo",       "eGf.viewPageInfo();"),
  new eG_menuItem(80,   0, "showOnlyThisFrame",  "eGf.showOnlyThisFrame();"),
  new eG_menuItem(81,  -1, "empty",              null),
  ...
  new eG_menuItem(90,   0, "toggleFindBar",      "eGf.toggleFindBar()"),
