  ...
  _addDefaultMenusMap(aPrefsMap) {
    ...
    let nonExtraMenus = [
      ...
      ["mainAlt2", ["loadURL2", "loadURL1", "showExtraMenu", "loadURL7",
                    "loadURL6", "empty", "loadURL5", "loadURL4",
                    "loadURL3", "empty"]],
      ...
      ["contextSelection", ["findAndHighlightSelection", "paste", "copy", "cut",
                            "searchWeb", "empty", "copyURLToTextFragment",
                            "bookmarkThisTextFragment", "removeHighlight",
                            "empty"]],
      ["contextTextbox", ["selectAll", "paste", "copy", "cut", "empty", "empty",
                          "empty", "empty", "empty", "empty"]]
    ];
    let extraMenus = [
      ["extra", ["pinUnpinTab", "newPrivateWindow", "copyPageURL",
                 "copyURLToTextFragment", "muteUnmuteTab"]],
